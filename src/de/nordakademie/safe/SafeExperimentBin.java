...
public class SafeExperimentBin {

        private SafeEventQueueBinaryLink<Object> eventQueueBinaryLink;
        private List<Long> times = new LinkedList<>();
        private Random rand = new Random();

        public double initialize(int initialSize){
            eventQueueBinaryLink = new SafeEventQueueBinaryLink<>(initialSize);
